...
def on_connect(client, userdata, flags, rc):
    if rc == 0:
        ...
        print("\nAguardando mensagens dos dispositivos...\n")
    else:
...
def main():
    ...
    try:
        ...
        print(f"Aviso: Não foi possível conectar à Contabo: {e}")
        print(f"Gateway continuará funcionando localmente.\n")
        contabo_client = None
